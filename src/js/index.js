...
function render(variables = {}) {
  ...
  if (variables.name == null) {
    variables.name = "anafrancis";
  }
  if (variables.lastname == null) {
    variables.lastname = "amador";
  }
  if (variables.twitter == null) {
    variables.twitter = "francis";
  }
  if (variables.instagram == null) {
    variables.instagram = "fran123";
  }
  if (variables.linkedin == null) {
    variables.linkedin = "ana";
  }
  if (variables.github == null) {
    variables.github = "anafran12";
  }
  if (variables.socialMediaPosition == "left") {
    variables.socialMediaPosition = "web developer";
  }
  if (variables.country === null) {
    variables.country = "costarrica";
  }
  if (variables.city == null) {
    variables.city = "guanacaste";
  }
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class="${variables.socialMediaPositionbles}">
